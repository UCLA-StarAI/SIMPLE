...
def create_exactly_k(n, k):
    global literals
    literals = dict(list(chain.from_iterable(((i, Node(i, type=LITERAL)), (-i, Node(-i, type=LITERAL))) for i in range(1, n+1))))
...
if __name__ == "__main__":
    alpha = create_exactly_k(8192, 1000)[0][-1]
    with open('8192C1000.pkl', 'wb') as out:
